      ...
      <Card className="hover:shadow-lg transition-all duration-200 hover:-translate-y-1 cursor-pointer">
        <CardContent className="p-6">
          <div className="flex items-center mb-4">
            <div className={`w-16 h-16 bg-gradient-to-br ${getGradientColor(0)} rounded-lg flex items-center justify-center`}>
            ...
            <div className="mr-4 flex-1">
              ...
              <p className="text-sm text-muted-foreground">{company.classification || 'غير محدد'}</p>
            </div>
          </div>
