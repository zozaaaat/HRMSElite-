...
export const companies = sqliteTable(
  ...
  (table) => [
    ...
    index("IDX_companies_commercial_file_number").on(
      table.commercialFileNumber,
    ),
...
export const employeeLeaves = sqliteTable(
  "employee_leaves",
  {
    id: text("id")
      .primaryKey()
  ...
  (table) => [
    ...
    index("IDX_employee_leaves_employee_status").on(
      table.employeeId,
      table.status,
    ),
...
export const employeeDeductions = sqliteTable(
  "employee_deductions",
  {
    id: text("id")
      .primaryKey()
    ...
    status: text("status", { enum: deductionStatusEnum })
      .default("active")
      .notNull(),
  ...
  (table) => [
    ...
    index("IDX_employee_deductions_employee_type").on(
      table.employeeId,
      table.type,
    ),
...
export const employeeViolations = sqliteTable(
  "employee_violations",
  {
    id: text("id")
      .primaryKey()
  ...
  (table) => [
    ...
    index("IDX_employee_violations_employee_type").on(
      table.employeeId,
      table.type,
    ),
  ],
...
export const documents = sqliteTable(
  ...
  (table) => [
    ...
    index("IDX_documents_entity_entity_type").on(
      table.entityId,
      table.entityType,
    ),
...
export const insertEmployeeDeductionSchema =
  createInsertSchema(employeeDeductions);
export const insertEmployeeViolationSchema =
  createInsertSchema(employeeViolations);
...
export type InsertEmployeeDeduction = z.infer<
  typeof insertEmployeeDeductionSchema
>;
export type EmployeeViolation = typeof employeeViolations.$inferSelect;
export type InsertEmployeeViolation = z.infer<
  typeof insertEmployeeViolationSchema
>;
