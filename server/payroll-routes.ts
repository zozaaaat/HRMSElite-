...
export function registerPayrollRoutes(app: Express) {
  ...
  app.get('/api/payroll/company/:companyId', isAuthenticated, requireRole(['super_admin', 'company_manager']), async (req, res) => {
    try {
  ...
  app.post('/api/payroll/process/:companyId', isAuthenticated, requireRole(['super_admin', 'company_manager']), async (req, res) => {
    try {
      const { companyId } = req.params;
  ...
  app.get('/api/payroll/reports/:companyId', isAuthenticated, requireRole(['super_admin', 'company_manager']), async (req, res) => {
    try {
      const { companyId } = req.params;
      ...
      res.json((reports as any)[type as string] || reports.monthly);
    } catch (error) {
  ...
  app.get('/api/payroll/taxes/:companyId', isAuthenticated, requireRole(['super_admin', 'company_manager']), async (req, res) => {
    try {
      const { companyId } = req.params;
